...
rnd_search = RandomizedSearchCV(my_model, param_distributions=param_distribs, n_iter=20, cv=5, scoring='balanced_accuracy', random_state=42)
rnd_search.fit(X_train,y_train)
print(rnd_search.best_params_)

rnd_forest = RandomForestClassifier(max_depth=14, max_features=2, min_samples_leaf=2, n_estimators=9)
...
svc_poly = SVC(kernel = 'poly', degree = 8, coef0= 1, C=5)
...
rnd_search.fit(X_train,y_train)
print(rnd_search.best_params_)
svc_rbf_low_gamma = SVC(kernel = 'rbf', gamma=0.1, C=770)
